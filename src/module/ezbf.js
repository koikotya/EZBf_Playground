...
["_main","_gen_code","_get_err","_fflush","onRuntimeInitialized"].forEach((prop) => {
...
var wasmBinaryFile;
if (Module['locateFile']) {
  wasmBinaryFile = 'ezbf.wasm';
  if (!isDataURI(wasmBinaryFile)) {
    wasmBinaryFile = locateFile(wasmBinaryFile);
  }
} else {
  // Use bundler-friendly `new URL(..., import.meta.url)` pattern; works in browsers too.
  wasmBinaryFile = new URL('ezbf.wasm', import.meta.url).href;
}
...
/** @type {function(...*):?} */
var _gen_code = Module["_gen_code"] = createExportWrapper("gen_code");
/** @type {function(...*):?} */
